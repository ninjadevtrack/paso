 ...
 */
?>
<div class="project-item item-sm">
  <div class="project-item-inner">
    <figure class="alignnone project-img">
      <?php print $fields['field_images']->content; ?>
      <div class="overlay">
        <a href="<?php print isset($fields['path']) ? $fields['path']->content : '#'; ?>" class="dlink"><i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </figure>
    <div class="project-desc item-desc">
      <div class="meta">
